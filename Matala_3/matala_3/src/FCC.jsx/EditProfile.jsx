...
function EditProfile({ user, updateUser, adminEditUser }) {
    ...
    const updateUserHandler = (event) => {
        ...
        if (!handleError(v, "image", (register.imageFile.length === 0 || register.imageFile.toUpperCase().endsWith("JPG") || register.imageFile.toUpperCase().endsWith("JPEG")))) { return; }
        ...
        let isSuccess;
        if (adminEditUser !== undefined) {
            isSuccess = adminEditUser(updatedUser);
        } else {
            isSuccess = editUser(updatedUser);
        }
        if (isSuccess) {
            ...
            <form onSubmit={updateUserHandler}>
                <div style={{ flex: 1 }}>
                    ...
                    <div style={{ paddingBottom: 5 }}>
                        ...
                        <input style={{ marginLeft: 11, display: 'none' }} type="file" id="image" onChange={changeImageHandler} />
                    ...
                    <div style={{ paddingBottom: 5 }}>
                        <label>Email: </label>
                        <input style={{ marginLeft: 92 }} type="email" id="email" value={register.email} onChange={changeHandler} required disabled placeholder="Your email" />
                    ...
                    <div>
                        <PinkButton style={{ marginLeft: 85 }} size="large" variant="contained" type="submit" startIcon={<PublishIcon />}>UPDATE</PinkButton>
                    </div>
                </div>
            </form>
